...
const zone01 = document.querySelector('.zone-01');
const zone02 = document.querySelector('.zone-02');
...
const zone32 = document.querySelector('.zone-32');
...
const secondbigtable = document.querySelector('#secondbigtable');

const krislo = document.querySelector('#krislo');
const pufik = document.querySelector('#pufik');
const divan = document.querySelector('#divan');
const styl = document.querySelector('#styl');

const firstbad = document.querySelector('#firstbad');
const secondbad = document.querySelector('#secondbad');


zone0.ondragover = allowDrop;
zone01.ondragover = allowDrop;
zone02.ondragover = allowDrop;
...
table.ondragstart = drag;
bigtable.ondragstart = drag;
secondbigtable.ondragstart = drag;

krislo.ondragstart = drag;
pufik.ondragstart = drag;
divan.ondragstart = drag;
styl.ondragstart = drag;

firstbad.ondragstart = drag;
secondbad.ondragstart = drag;
